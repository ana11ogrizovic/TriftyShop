  ...
  useEffect(() => {
    const fetchAllProducts = async () => {
      try {
        ...
        if (response.ok) {
          setAllProducts(data);  // Svi proizvodi
          setProducts(data);  // Prikazujemo sve proizvode u početku
        } else {
    ...
    fetchAllProducts();
  }, []);  // Ovaj useEffect se poziva samo jednom prilikom učitavanja stranice
